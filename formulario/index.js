...
const saveTask = (title, description) =>
    //le decimos que en la DB guardaremos una coleccion con el nombre 'tasks', guardara .doc() un documento y dentro de este documento se guardara un objeto con las siguientes caracteristicas
...
window.addEventListener('DOMContentLoaded', async (e) => {
    ...
    onGetTasks((querySnapshot) => {
        ...
        querySnapshot.forEach(doc => {
            ...
            const task = doc.data();//guardamos el contenido en la const para no tener que escribir todo el tiempo doc.data()....
